...
<section class="py-5">
    ...
    <div class="container">
        ...
        <form action="{{route('admin.projects.update',$project->id)}}" method="post" class="card p-3" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="description" class="form-label">description</label>
                <textarea name="description" id="description" cols="30" rows="10" class="form-control @error('description') is-invalid @enderror" placeholder="insert a description">{{old('description',$project)}} </textarea>
                <small id="helpId" class="text-muted">insert a project description</small>
            </div>
